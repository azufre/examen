    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdBus = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Placa = table.Column<string>(nullable: true),
                    CantidadAsientos = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraSalida = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdViaje = table.Column<int>(nullable: false),
                    IdPasajero = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Boletos", x => x.IdBoleto);
                    table.ForeignKey(
                        name: "FK_Boletos_AspNetUsers_IdPasajero",
                        column: x => x.IdPasajero,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Boletos_Viajes_IdViaje",
                        column: x => x.IdViaje,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Boletos_IdPasajero",
                table: "Boletos",
                column: "IdPasajero");

            migrationBuilder.CreateIndex(
                name: "IX_Boletos_IdViaje",
                table: "Boletos",
                column: "IdViaje");

            migrationBuilder.CreateIndex(
                name: "IX_Viajes_IdBus",
                table: "Viajes",
                column: "IdBus");
        }
